...
export default function CreatePropertyPage() {
  ...
  const [features, setFeatures] = useState<
    { feature_id: number; feature_name: string }[]
  >([]);
  ...
  const [communes, setCommunes] = useState<
    { commune_id: number; commune_name: string }[]
  >([]);
  ...
  useEffect(() => {
    ...
    const loadDistricts = async () => {
      ...
      setFormData((prev) => ({
        ...prev,
        district_id: districtsData[0]?.district_id,
      }));
    };
    loadDistricts();
  }, [formData.city_id]);
  ...
  useEffect(() => {
    ...
    const loadCommunes = async () => {
      ...
      setFormData((prev) => ({
        ...prev,
        commune_id: communesData[0]?.commune_id,
      }));
    };
    loadCommunes();
  ...
  const handleFinalSubmit = async () => {
    if (
      ...
      toast.error(
        "Please ensure all location and category fields are selected."
      );
      return;
    }
          ...
          <div className="space-y-6">
            <div>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <label>
                    Rent Price (USD) <span className="text-red-500">*</span>
                  </label>
                  <input
                    name="rent_price"
                    type="number"
        ...
        return (
          <div>
            ...
            <label
              ...
              className="flex justify-center items-center w-full h-32 border-2 border-dashed rounded-lg cursor-pointer hover:bg-gray-50"
            >
              {isUploading ? (
          ...
          <div>
            ...
            <div className="space-y-2">
              ...
              <p>
                ...
                ,{" "}
                {
                  communes.find((c) => c.commune_id === formData.commune_id)
                    ?.commune_name
                }
              </p>
              <p>
                <strong>Rent:</strong> ${formData.rent_price}/month
              </p>
              <p>
                <strong>Images:</strong> {formData.media.length}
              </p>
              <p>
                <strong>Features:</strong> {formData.feature_ids.length}
              </p>
            </div>
          </div>
        );
      ...
      <div className="p-6 max-w-4xl mx-auto">
        ...
        <div className="flex justify-between mt-8">
          <button
            ...
            className="flex items-center px-6 py-2 border rounded disabled:opacity-50"
          >
          ...
          {currentStep < steps.length - 1 ? (
            ...
            <button
              ...
              className="flex items-center px-6 py-2 bg-green-800 text-white rounded disabled:bg-gray-400"
            >
              {isSubmitting ? (
