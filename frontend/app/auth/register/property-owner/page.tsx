...
type PropertyOwnerRegistrationFormData = {
  firstName: string;
  lastName: string;
  email: string;
  phone: string;
      ...
      <div className="flex-1 bg-white flex items-center justify-center p-8 lg:py-12 rounded-l-2xl shadow-xl relative overflow-hidden">
        ...
        <div className="w-full max-w-md space-y-6 relative z-10">
          ...
          <div className="text-center space-y-3">
            <h2 className="text-2xl lg:text-3xl font-extrabold text-gray-900 leading-tight">Create Your Property Owner Account</h2>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <div className="pt-2">
                ...
                <div className="flex items-center justify-center w-full">
                  <label htmlFor="idCardFile" className="flex flex-col items-center justify-center w-full h-24 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 hover:bg-gray-100 transition-colors">
                    <div className="flex flex-col items-center justify-center pt-5 pb-6">
                      <svg className="w-6 h-6 mb-2 text-gray-500" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 16">
                          <path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M13 13h3a3 3 0 0 0 0-6h-.025A5.56 5.56 0 0 0 16 6.5 5.5 5.5 0 0 0 5.207 5.021C5.137 5.017 5.071 5 5 5a4 4 0 0 0 0 8h2.167M10 15V6m0 0L8 8m2-2 2 2"/>
                      </svg>
                ...
                {formData.idCardFile && (
                  <p className="mt-2 text-xs text-[#20511e] font-medium text-center">Selected: {formData.idCardFile.name}</p>
                )}
              </div>
            </div>
          ...
          <div className="text-center space-y-2 pt-4 pb-8">
            ...
            <div className="pt-2">
              <Link href="/auth/register" className="text-gray-600 hover:text-[#20511e] font-medium transition-colors">
                <span aria-hidden="true">&larr;</span> Register as a Customer
              </Link>
            </div>
          </div>
        </div>
